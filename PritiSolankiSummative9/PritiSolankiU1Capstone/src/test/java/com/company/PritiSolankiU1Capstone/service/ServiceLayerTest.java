...
public class ServiceLayerTest {
    ...
    public void saveGetConsole(){
        ...
        System.out.println("Console Id : " + consoleViewModel.getConsoleId());
    ...
    public void saveGetTshirt() {
        ...
        System.out.println("TshirtId : " + tshirtViewModel.gettShirtId());
    ...
    public void findTshirtbyColor() {
        ...
        tshirtViewModel = serviceLayer.saveTshirt(tshirtViewModel);
            ...
            assertEquals(tshirtViewModelList.size(),1);
        System.out.println(tshirtViewModelList.get(0));
        System.out.println(tshirtViewModel);
    ...
    public void saveInvoice() {
        ...
        //Service Layer
        System.out.println("VVV BEFORE " + invoiceInputViewModel);
